...
public class SingleProductDisplayServlet extends HttpServlet {

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        String model = request.getParameter("model");
        ProductDisplay phone1 = new ProductDisplay();
        HashMap<String,Product> smartPhones = phone1.buildBasicProductDisplayList(); 
        int index=0;
        ...
        for(HashMap.Entry<String, Product> myKey: smartPhones.entrySet()){
            ...
            if((ph1.getModel().equalsIgnoreCase(model))){
                if(index%3==0){
                    out.println("<tr>");
                }
                out.println("<td>");
                ...
                out.println("</p>");
				out.println("<img height=70 width=70 class='header-image' src='Images/" + ph1.getImageName() + ".jpg'");     
                out.println("/>");
                out.println("<p>");  
				out.println("<br>");
				out.println("<br>");
                out.println("<a href='CartServlet?productId="+ph1.getProductId()+"'> <input class='button' type='button' value='Add To Cart'/>");       
                out.println("</a>");
                out.println("</p>");
                out.println("<p>");
