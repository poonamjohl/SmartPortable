...
public class WriteReviewsServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        out.println("<p><label for='productModelName'>Product Brand Name</label>");
        ...
        out.println("<input name='retailerName' id='retailerName' value='Smart Portable' readonly  type='text'/></p>");
        out.println("<p><label for='retailerZip'>Retailer Zip</label>");
        out.println("<input name='retailerZip' id='retailerZip' value=''  placeholder= 'Zip Code' pattern='[0-9]{5}' title='5 Number Zip Code' min='00000'/></p>");
