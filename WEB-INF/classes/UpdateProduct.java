...
public class UpdateProduct extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        out.println("&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input class=button type='submit' value='Update'/></center>");
        out.println("</form>");
        out.println("</fieldset>"); 
        out.println("</section>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{		
        ...
        out.println("<br><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input class=button type='submit' value='Update'/>");
        out.println("</form>");
        out.println("</fieldset>"); 
        out.println("</section>");
        utility.printHtml("C:/apache-tomcat-7.0.34/webapps/csj1/LeftNavigationBar.html",response);
